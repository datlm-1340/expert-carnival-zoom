  ...
  return <>
    ...
    <fieldset>
      ...
      <details>
        <summary>
          <span>User:</span>
          <input type="text" name="userId" value={data.userId} onChange={change} />
        </summary>
        <p>
      ...
      <details>
        <summary>
          <span>Agenda:</span>
          <textarea type="text" name="agenda" value={data.agenda} onChange={change} />
        </summary>
        <p>
      ...
      <details>
        <summary>
          <span>Password:</span>
          <input type="text" name="password" maxLength={10} value={data.password} onChange={change} />
        </summary>
        <p>
      ...
      <fieldset>
        ...
        <details>
          <summary>
            ...
            <input type="checkbox" name="allow_multiple_devices" defaultChecked={data.allow_multiple_devices} onChange={change} />
          </summary>
          <p>
        ...
        <details>
          <summary>
            ...
            <input type="checkbox" name="private_meeting" defaultChecked={data.private_meeting} onChange={change} />
          </summary>
          <p>
        ...
        <details>
          <summary>
            ...
            <input type="text" name="approval_type" value={data.approval_type} onChange={change} />
          </summary>
          <p>
            Enable meeting registration approval:<br />

            0 — Automatically approve registration.<br />
            1 — Manually approve registration.<br />
      ...
      <details>
        <summary>
          <span>Topic:</span>
          <input type="text" name="topic" value={data.topic} onChange={change} />
        </summary>
        <p>
          The meeting's topic.
        </p>
